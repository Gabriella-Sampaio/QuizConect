const perguntas = [
    {
        ...
        opcoes: [
            { valor: 'streaming', texto: 'Assistir filmes e séries', icone: '🎬', peso: 45 },
            { valor: 'trabalho', texto: 'Trabalhar e estudar', icone: '💼', peso: 35 },
            { valor: 'jogos', texto: 'Jogar online', icone: '🎮', peso: 45 },
    ...
    // },
    {
        ...
        opcoes: [
            ...
            { valor: 'sofrendo', texto: 'Tenho, mas TRAVA direto! 😤', icone: '😤', peso: 10 },
    ...
    },
    {
        ...
        opcoes: [
            { valor: 'kitnet', texto: 'Kitnet ou apartamento pequeno', icone: '🏢', peso: 5 },
            { valor: 'apto_grande', texto: 'Apartamento grande (3+ quartos)', icone: '🏢', peso: 5 },
            { valor: 'casa', texto: 'Casa', icone: '🏠', peso: 15 },
            { valor: 'casa_grande', texto: 'Sobrado/ dois andares', icone: '🏡', peso: 25 }
        ]
    }
    // ,
    // {
...
function gerarTextoPersonalizado(plano) {
    ...
    personalizacao += `Por isso, recomendamos o <strong>${plano.nome} (${plano.velocidade})</strong><div class="alerta-mesh">
    <strong>Benefícios do assinante: Etecc+</strong> Mais de<strong> centenas de E-books</strong> para ler onde quiser. Plataforma com <strong>vallets/descontos</strong> em grandes empresas do Brasil. Acesso a mais de <strong>150 cursos</strong> de diversas modalidades e com certificação<br><a href="https://eteccnet.com.br/"><strong>Saiba mais clicando aqui</strong></a></div>.`;
